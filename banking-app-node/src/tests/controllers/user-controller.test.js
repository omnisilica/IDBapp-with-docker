...
const { userRouter }  = require('../../main/controllers/user-controller.js'); 
  ...
  describe('UserController', () => {
    describe('loginUser', () => {
      it('should create a session on successful login', async () => {
        ...
        const mockToken = 'a.fake.jwt.token';
        ...
        expect(response.status).toBe(200);
        expect(response.body).toEqual({ customer: mockUser, token: mockToken });
      });
